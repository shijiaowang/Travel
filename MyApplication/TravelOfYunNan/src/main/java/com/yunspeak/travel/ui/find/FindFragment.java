...
public class FindFragment extends LoadBaseFragment<FindEvent> implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.ll_add:
                ...
                break;
            case R.id.ll_hotel:
                startActivity(new Intent(getContext(), HotelReservationActivity.class));
                break;
        }
    }
    class HomePagerAdapter extends PagerCursorView.CursorPagerAdapter {
        ...
        public Object inflateView(ViewGroup container, int position) {
                ...
                imageView.setOnClickListener(new MyOnClickListener(getContext(), (FindBean.DataBean.RecommendBean) imageView.getTag(),imageView));
