...
public class AppointDetailMorePop {
    public static void showMorePop(final Context context, final String id, View view, final String type, String collection, final ParentPopClick parentPopClick) {
        // 获取弹出视图对象
