...
public class SelectDestinationActivity extends LoadingBarBaseActivity<DestinationEvent> implements XListView.IXListViewListener {
    ...
    private String type;
    private List<DestinationBean.DataBean.BodyBean> destinationData;
    ...
    protected void initEvent() {
        ...
        mTvRight.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DestinationBean.DataBean.BodyBean bodyBean = destinationData.get(GlobalValue.clickPosition);
    ...
    private void dealDestinationData(DestinationEvent event) {
        DestinationBean destination = GsonUtils.getObject(event.getResult(), DestinationBean.class);
        if (destinationAdapter == null) {
            ...
            List<DestinationBean.DataBean.BodyBean> body = destination.getData().getBody();
