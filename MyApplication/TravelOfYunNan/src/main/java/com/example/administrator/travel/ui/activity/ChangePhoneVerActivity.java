    ...
    protected void initEvent() {
        mBtSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Map<String, String> changeMap = MapUtils.Build().addKey(ChangePhoneVerActivity.this).add(IVariable.TEL, phone).add(IVariable.USER_ID, GlobalUtils.getUserInfo().getId()).add(IVariable.TEL, getString(mEtVer)).end();
                XEventUtils.postUseCommonBackJson(IVariable.CHANGE_PHONE,changeMap,0);
            }

        });
        mEtVer.addTextChangedListener(new TextWatcher() {
            @Override
