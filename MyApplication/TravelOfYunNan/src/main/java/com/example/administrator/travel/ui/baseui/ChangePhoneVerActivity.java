 ...
 * 更改手机号验证码页面
 */
public class ChangePhoneVerActivity extends LoadingBarBaseActivity<ChangePhoneVerEvent> {
    ...
    @Override
    protected void onSuccess(ChangePhoneVerEvent changePhoneVerEvent) {
