package com.example.administrator.travel.volly;
...
public class MultiPartStack extends HurlStack {
	...
	public HttpResponse performRequest(Request<?> request,
		...
		if(!(request instanceof MultiPartRequest2)) {
	...
	private static void setMultiPartBody(HttpEntityEnclosingRequestBase httpRequest,
		...
		Map<String, File> fileUpload = ((MultiPartRequest2) request).getFileUploads();
		...
		Map<String, String> stringUpload = ((MultiPartRequest2) request).getStringUploads();
