...
import yunshuo.yneb.com.myapplication.activity.ServiceHomeActivity;
...
public class ServiceHelper {
    ...
    public  void  setUserProfileProvider(final Context appContext){
        ...
        easeUI.getNotifier().setNotificationInfoProvider(new EaseNotifier.EaseNotificationInfoProvider() {
            ...
            public Intent getLaunchIntent(EMMessage message) {
                Intent intent;
                if (ServiceHomeActivity.instance==null){
                    intent=new Intent(appContext,ServiceHomeActivity.class);
    ...
    public synchronized static ServiceHelper getInstance() {
        if (instance == null) {
